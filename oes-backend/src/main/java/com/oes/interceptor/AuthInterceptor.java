...
public class AuthInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (isDataModification(method, uri)) {
            try {
                String operation = OperationDescUtil.getOperationDesc(method, uri);
                sysLogService.saveLog(username, operation, method,
    ...
    private boolean isDataModification(String method, String uri) {
